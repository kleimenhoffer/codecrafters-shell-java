...
public class Main {
    ...
    private static void executeBuiltinCommand(List<String> parts, InputStream in, OutputStream out, OutputStream err,
    ...
    public static void main(String[] args) throws Exception {
        ...
        while (true) {
            ...
            if (command.equals("echo")) {
                ...
                String output = currentDir.getAbsolutePath();
